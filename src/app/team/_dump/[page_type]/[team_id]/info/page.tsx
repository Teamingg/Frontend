...
import TeamPageInfo from "./_components/TeamPageInfo";
import {useParams} from "next/navigation";
import {MentoringInfo, ProjectInfo} from "@/types/team/teamPageInfo";
...
const Page = <T extends ProjectInfo | MentoringInfo> () => {
  ...
  return (
      <TeamPageInfo
          ...
          content={"dto" in data ? data.dto.content : data.contents}
          authority={"LEADER"}
