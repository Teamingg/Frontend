...
export const TeamSection = ({
  ...
  return (
    <article className="w-full p-8 bg-white rounded-xl">
      ...
      {!isEmpty ? (
        <ul className="grid grid-cols-2 lg:grid-cols-4 gap-2">{children}</ul>
      ) : (
        <div className="text-center my-10">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link
              href={`/${pageType}`}
              className="px-4 py-2 border border-blue-500 text-blue-500 rounded hover:bg-blue-100 text-sm md:text-base"
            >
