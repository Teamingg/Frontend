...
const ProjectForm = ({
  ...
  const months = useMemo(() => getSelectableMonths(90, date), [date]);
  const startDays = useMemo(() => getSelectableDays(startMonth, 90, date), [startMonth, date]);
  const endDays = useMemo(() => getSelectableDays(endMonth, 90, date, 30), [endMonth, date]);
  console.log(endDays, endMonth, endDays);
